...
export const POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      "A practitioner's walkthrough of everything you need to conduct a comprehensive AI security audit — from scoping the engagement to delivering the report. Covers NIST AI RMF, OWASP LLM Top 10, and the 6-Domain methodology.",
    category: "Practitioner How-Tos",
    readTime: "14 min read",
    date: "May 2026",
    hasTemplate: true,
    primaryKeyword: "AI security audit",
    content: `
...
If you're ready to develop these skills yourself, [enroll in the course](/course) and work through the full methodology hands-on.
  ...
  {
    slug: "nist-ai-rmf-explained",
    title: "NIST AI RMF 1.0 Explained in Plain English",
    excerpt:
      "The NIST AI Risk Management Framework is the federal government's guidance for managing AI risk. Here's what it actually says, how it's structured, and how to apply it in a real audit context — without the government-document fog.",
    category: "Framework Guides",
    readTime: "9 min read",
    date: "May 2026",
    hasTemplate: false,
    primaryKeyword: "NIST AI RMF",
    content: `
...
- [OWASP LLM Top 10](/blog/owasp-llm-top-10)
  ...
  },
  {
    ...
    excerpt:
      "73% of SMBs have no written AI Acceptable Use Policy. Here's what needs to be in one, why it matters legally, and a free template you can adapt for your organization.",
    category: "Practitioner How-Tos",
    readTime: "8 min read",
    date: "May 2026",
    hasTemplate: true,
    primaryKeyword: "AI acceptable use policy",
    content: `
...
Annual recertification is good practice as the policy will need to evolve.
  ...
  {
    slug: "shadow-ai-what-it-is-why-dangerous-how-to-find-it",
    title: "Shadow AI: What It Is, Why It's Dangerous, and How to Find It",
    excerpt:
      "Shadow AI is the unauthorized AI tools your employees are using right now without your knowledge or approval. Here's what it looks like, why it creates serious liability, and the techniques auditors use to uncover it.",
    category: "AI Risk Education",
    readTime: "7 min read",
    date: "May 2026",
    hasTemplate: false,
    primaryKeyword: "shadow AI",
    content: `
## What Is Shadow AI?
...
The goal is a governed AI environment, not a tool-free one. The organizations that try to eliminate AI use entirely will lose the productivity benefit and still have the shadow AI problem.
  ...
  },
  {
    ...
    excerpt:
      "The OWASP Top 10 for LLM Applications is the definitive reference for LLM-specific security risks. Here's what all 10 risks mean in practice, with real examples and the controls that address each one.",
    category: "Framework Guides",
    readTime: "11 min read",
    date: "May 2026",
    hasTemplate: false,
    primaryKeyword: "OWASP LLM Top 10",
    content: `
